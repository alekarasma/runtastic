...
class ActiveRunService : Service() {
    ...
    private val baseNotification by lazy {
        NotificationCompat.Builder(applicationContext, CHANNEL_ID)
            .setSmallIcon(com.asmaa.core.presentation.designsystem.R.drawable.logo)
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        when (intent?.action) {
            ACTION_START -> {
                ...
                startService(Class.forName(activityClass))
            }
    ...
    private fun startService(classActivity: Class<*>) {

        if (!isServiceActive) {
            isServiceActive = true
            createNotificationChannel()
            val activityIntent = Intent(applicationContext, classActivity).apply {
                data = "runtastic://active_run".toUri()
    ...
    companion object {
        ...
        private val CHANNEL_ID = "active_run"
