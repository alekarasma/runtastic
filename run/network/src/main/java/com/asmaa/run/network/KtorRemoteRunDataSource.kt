...
import com.asmaa.core.data.networking.constructRoute
import com.asmaa.core.data.networking.delete
import com.asmaa.core.data.networking.get
import com.asmaa.core.data.networking.safeCall
...
import com.asmaa.core.domain.util.map
...
class KtorRemoteRunDataSource(private val httpClient: HttpClient) : RemoteDataSource {
    ...
    override suspend fun postRun(run: Run, mapPicture: ByteArray): Result<Run, DataError.NetworkError> {
